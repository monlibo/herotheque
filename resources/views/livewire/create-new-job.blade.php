    ...
    <main>
        <div id="form-step-container" class="">
            <div
                ...
                <p class="text-[16px]">AJOUTER UN NOUVEAU JOB</p>
                        ...
                        <div action="" class="form">
                            ...
                            <div class="input-container">
                                <label class="label" for="type">
                                    Type de job <span class="text-red-500">*</span>
                                </label>
                                <div wire:ignore>
                                    <select wire:model="type" id="type" class="input w-[15px]">
                                        <option value="">Selectionner un type de job</option>
                        ...
                        <div action="" class="form">
                            ...
                            @if ($salary_fixed == true)
                                ...
                                <div class="input-container">
                                    ...
                                    <input wire:model="salary" class="input" id="salary" type="number" min="1">
