        ...
        <main class="">
            @if ($internship)
                <div id="form-step-container">
                    ...
                    <form method="post" wire:submit.prevent="updateInternship">
                        @csrf
                        ...
                        <div
                            ...
                            <p class="text-[16px]">MODIFIER UNE OFFRE DE STAGE</p>
                        </div>
                                            ...
                                            <select wire:model="type" id="type" class="input w-[15px]">
                                                ...
                                                @foreach ($types as $typ)
                                                    <option @if ($typ['code'] == $type) selected @endif
                                                        value="{{ $typ['code'] }}">{{ $typ['libelle'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                        ...
                        <div class="form-collection-container" id="fcc-7">
                            ...
                            <div class="form-container">
                                <div class="form">
                                    <!-- Niveau d'étude exigé -->
                                    @if ($internship->offer->publication_date > now())
                                        <div class="input-container">
