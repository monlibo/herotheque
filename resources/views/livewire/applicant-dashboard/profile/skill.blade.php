        ...
        <div class="w-full flex flex-col space-y-4">
            @if (count($skills) > 0)
                ...
                @foreach ($skills as $skill1)
                    <div
                        class="w-full flex flex-col @if ($i !== count($skills)-1) border-b-[2px] border-gray-200 dark:border-gray-600 @endif space-y-2 relative  justify-between pb-4">
                        <div class="w-full flex space-x-4  justify-between relative">
                            <div class="flex-1 w-full flex-col flex md:flex-row justify-between md:space-x-6">
                                <div class="flex flex-1 flex-col">
                                    <span class="font-semibold dark:text-gray-200 text-black ">{{ $skill1['name'] }}</span>

                                </div>
                                <div class="flex flex-col space-y-1 h-full  text-gray-500">

                                    <span>{{ $skill1['level'] }}</span>
                                </div>
                            </div>
                ...
                <div class="flex justify-between w-full space-x-3">
                    <div
                        ...
                        <div class="input-container">
                            ...
                            <div x-data="{
                                skill: @entangle('skill'),
                            }" x-init="select2 = $('#skill0').select2({ tags: true, width: '100%', });
                            ...
                            select2.on('select2:unselect', (event) => {
                                ...
                                <select x-ref="skill" wire:model.debounce.1000s="skill" class="input"
                                    name="skill" id="skill0">
                        ...
                        <div class="input-container">
                            ...
                            <select wire:model="level" class="input" name="skill" id="newLevel">
    ...
    <div x-cloak x-show="openEditForm"
        ...
        <div class="bg-white dark:bg-gray-800 dark:text-gray-200 shadow-2xl rounded-md w-1/2 flex flex-col p-4 space-y-4 ">
            ...
            <div class="flex flex-col w-full space-y-4 items-center">
                <div class="flex flex-col  space-y-3 w-full bg-gray-50 dark:bg-gray-800 dark:text-gray-200 p-2 rounded-b-md">
                    <form wire:submit.prevent="update" method="POST">
                        ...
                        <div class="flex justify-between w-full space-x-3">
                            <div class="input-container !w-[70%]">
                                ...
                                <div x-data="{
                                    skill: @entangle('skill'),
                                }" @select2.window="select2 = $('#skill1').select2({ tags: true, width: '100%', });
                                select2.on('select2:select', (event) => {
                                    skill = event.target.value;
                                });
                                select2.on('select2:unselect', (event) => {
                                    ...
                                    w-full">
                                    <select  wire:model.debounce.1000s="skill" class="input"
                                        name="skill" id="skill1">
                            ...
                            <div class="input-container !w-[30%] ">
                                ...
                                <select wire:model="level" class="input dark:!bg-gray-800 dark:text-gray-200" name="skill" id="newLevel">
                                    <option value="débutant">Débutant</option>
                                    <option value="intermédiaire">Intermédiaire</option>
                                    <option value="expérimenté">Avancée</option>
                                </select>
        ...
        <div
            ...
            <div class="bg-white dark:bg-gray-800 dark:text-gray-200 shadow-2xl rounded-md w-full lg:w-1/2 flex flex-col p-4 space-y-4 ">
                <div class="w-full py-2 px-4 flex flex-col  items-start">
                    <p class="text-[16px] font-semibold">Etes-vous sur de vouloir supprimer cette compétence ?</p>
