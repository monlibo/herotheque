        ...
        <main class="">
            @if ($employement)
                <div id="form-step-container">
                    ...
                    <form method="post" wire:submit.prevent="updateEmployement">
                        @csrf
                        <div
                            class="my-0 text-[14px] px-8 flex flex-col space-y-3  font-semibold bg-white dark:bg-gray-800 0 rounded-t-md border-b-2 border-gray-700 py-8 w-full  text-gray-700 dark:text-gray-200">
                            <p class="text-[16px]">MODIFIER UNE OFFRE D'EMPLOI</p>
                        </div>
                            ...
                            <div class="form-container">
                                <div action="" class="form">
                                    ...
                                    <div class="input-container">
                                        ...
                                        <div>
                                            <select class="input editable" id="offered_position"
                                                wire:model="offered_position">
                            ...
                            <div class="form-container">
                                <div class="form">
                                    ...
                                    <div class="input-container">
                                        ...
                                        <div>
                                            <select wire:model="type_of_contract" id="type_of_contract"
                                                class="input w-[15px]">
                                                ...
                                                @foreach ($contracts as $contrat)
                                                    <option @if ($contrat['code'] == $type_of_contract) selected @endif
                                                        value="{{ $contrat['code'] }}">{{ $contrat['libelle'] }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="input-container" x-show="salary_fixed">
                                    ...
                                    <div id="salary_start_div" class="input-container">
                                        ...
                                        <input wire:model="min_salary" class="input" id="min_salary"
                                            type="number" min="1" autocomplete="">
                                    ...
                                    <div class="input-container">
                                        ...
                                        <div>
                                            <select wire:model="payment_frequency" class="input"
                                                ...
                                                @endforeach
                                                <option selected value="{{ $payment_frequency }}">
                                                    {{ $payment_frequency }}
                                                </option>
                                            </select>
                                        </div>
                            ...
                            <div class="form-container">
                                <div class="form">
                                        ...
                                        <div wire:ignore>
                                            <select id="quality" multiple wire:model="quality"
                                                ...
                                                @foreach ($quality as $quality)
                                                    <option selected value="{{ $quality }}">{{ $quality }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="input-container">
                                        ...
                                        <select wire:model="driver_licence" class="input"
                        ...
                        <div class="form-collection-container" id="fcc-7">
                            ...
                            <div class="form-container">
                                <div class="form">
                                    <!-- Niveau d'étude exigé -->
                                    @if ($employement->offer->publication_date > now())
                                        <div class="input-container">
                                            <label class="label" for="date_of_publication">
                                                Date de publication de l'offre
                                            </label>

                                            <input type="date" wire:model="date_of_publication"
                                                name="date_of_publication" id="date_of_publication"
                                                class="input">
