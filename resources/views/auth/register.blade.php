<x-guest-layout>
    ...
    <div class="flex">
        ...
        <div class="flex flex-col align-center h-auto w-full bg-white py-8 lg:w-1/2 justify-center items-center  space-y-0">
            ...
            <div class="w-full  md:px-32 lg:px-24">
                <form method="POST" action="{{ route('register') }}" class="bg-white rounded-md  px-4 py-5">
                    @csrf
                    <h1 class="text-gray-800 font-bold text-2xl mb-1 text-center">Inscription</h1>
                    <p class="text-sm font-normal text-gray-600 mb-8 text-center">Bienvenu(e) sur notre plateforme</p>

                    <x-jet-validation-errors class="mb-4" />
                    <div class="flex items-center  mb-8 md:px-3 rounded-2xl">
                    ...
                    <div class="flex items-center mb-6 md:px-3 rounded-2xl ">
                        <select name="role_id" id="role_id"
                            ...
                            <option value="2">Embaucheur</option>
                        ...
                        <div class="flex items-center mb-6 md:px-3 rounded-2xl">
                            ...
                            <div class="ml-2">
                                ...
                                <a target="_blank" href="{{ route('terms.show') }}"
                                    class="underline text-sm text-gray-600 hover:text-gray-900">Termes de Service</a> et
                                les
                                <a target="_blank" href="{{ route('policy.show') }}"
                                    class="underline text-sm text-gray-600 hover:text-gray-900">Politiques de
                                    Confidentialité</a>
                    ...
                    <button type="submit"
                        class="block w-full bg-blue-500 mt-5 py-2 rounded-md hover:bg-indigo-700 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2">S'inscrire</button>
                    <div class="flex justify-end mt-4">


                        @if (Route::has('login'))
                            <a href="{{ route('login') }}"
                                class="text-sm ml-2 hover:text-blue-500 cursor-pointer hover:-translate-y-1 duration-500 transition-all">Déjà
                                membre?</a>
                        @endif
