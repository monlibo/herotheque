...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('data', function () {
  return {
    ...
    closeAddMenu: function closeAddMenu() {
    ...
    isPostChoiceOpen: false,
    togglePostChoice: function togglePostChoice() {
      this.isPostChoiceOpen = !this.isPostChoiceOpen;
    },
    closePostChoice: function closePostChoice() {
      this.isPostChoiceOpen = false;
    },
    ...
    closePagesMenu: function closePagesMenu() {
